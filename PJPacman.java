...
public class PJPacman extends JPanel implements ActionListener { //inheritance 
    ...
    private void showIntroScreen(Graphics2D g2d) {
        ...
        String e = "Please enter spacebar to start game.";
        Font small = new Font("Helvetica", Font.BOLD, 14);
        FontMetrics metr = this.getFontMetrics(small);

        g2d.setColor(Color.white);
        g2d.setFont(small);
        g2d.drawString(e, (scrsize - metr.stringWidth(e)) / 2, scrsize / 2);
    }
    ...
    private void loadImages() {//Encapsulation
    ...
    class TAdapter extends KeyAdapter {//inheritance //event handling
